...
def subject_create(request):
    ...
    if request.POST and form.is_valid():
        ...
        actions = request.session.get('actions', [])
        actions += [f"You create subject: {request.POST.get('name')}"]
        request.session["actions"] = actions
...
def subject_edit(request,pk):
    ...
    if request.POST and form.is_valid():
        ...
        actions = request.session.get('actions', [])
        actions += [f"You edit subject: {request.POST.get('name')}"]
        request.session["actions"] = actions
...
def teacher_create(request):
    ...
    if request.POST and form.is_valid():
        ...
        actions = request.session.get('actions', [])
        actions += [f"You create teacher: {request.POST.get('first_name')}"]
        request.session["actions"] = actions
...
def teacher_edit(request,pk):
    ...
    if request.POST and form.is_valid():
        ...
        actions = request.session.get('actions', [])
        actions += [f"You edit teacher: {request.POST.get('first_name')}"]
        request.session["actions"] = actions
...
def group_create(request):
    ...
    if request.POST and form.is_valid():
        ...
        actions = request.session.get('actions', [])
        actions += [f"You create group: {request.POST.get('name')}"]
        request.session["actions"] = actions
...
def group_edit(request,pk):
    ...
    if request.POST and form.is_valid():
        ...
        actions = request.session.get('actions', [])
        actions += [f"You edit group: {request.POST.get('name')}"]
        request.session["actions"] = actions
...
def student_create(request):
    ...
    if request.POST and form.is_valid():
        ...
        actions = request.session.get('actions', [])
        actions += [f"You create student: {request.POST.get('first_name')}"]
        request.session["actions"] = actions
